...
\release{1.2}                   % software release
\setreleaseinfo{}               % empty for final release
\setshortversion{1.2}           % major.minor only for software
...
\begin{funcdesc}{Connection}{\var{dsn}\optional{\var{autocommit=False}}}
...
\strong{NOTE:} The DB API definition does not define these objects.
...
\begin{funcdesc}{columnprivileges}{\var{catalog=None}, \var{schema=None},
    \var{table=None}, \var{column=None}}
...
\begin{funcdesc}{columns}{\var{catalog=None}, \var{schema=None},
    \var{table=None}, \var{column=None}}
...
\begin{funcdesc}{foreignkeys}{\var{pkcatalog=None}, \var{pkschema=None},
    \var{pktable=None}, \var{fkcatalog=None}, \var{fkschema=None},
    \var{fktable=None}}
...
\begin{funcdesc}{primarykeys}{\var{catalog=None}, \var{schema=None},
    \var{table=None}}
...
\begin{funcdesc}{procedurecolumns}{\var{catalog=None}, \var{schema=None},
    \var{proc=None} \var{column=None}}
...
\begin{funcdesc}{procedures}{\var{catalog=None}, \var{schema=None},
    \var{proc=None}}
...
\begin{funcdesc}{tableprivileges}{\var{catalog=None}, \var{schema=None},
    \var{table=None}}
...
\begin{funcdesc}{tables}{\var{catalog=None}, \var{schema=None},
    \var{table=None}}
...
\begin{funcdesc}{fetchmany}{\var{numRows=cursor.arraysize}}
...
\begin{funcdesc}{getvalue}{\var{pos=0}}
